...
const AssignStationPage = () => {
  ...
  return (
    <div className="flex flex-col w-full h-screen p-8 bg-gray-50 space-y-6">
      <UiPageHeader mainTitle="Station Management" subTitle="Assign Station" />
            ...
            <form className="space-y-4">
              ...
              <SelectGroup>
                ...
                <Select
                  disabled
                  onValueChange={(value) =>
                    setSelectedStation((prev) => ({ ...prev, location: value }))
                  }
      ...
      {modalState.isOpen && modalState.type === "delete" && selectedStation && (
        <UiModal
          opened={modalState.isOpen}
          close={closeModal}
          maxWidth="max-w-lg"
